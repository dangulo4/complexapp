...
User.prototype.validate = function () {
  return new Promise(async (resolve, reject) => {
    ...
    // Only if username is valid then check to see if it's akready taken
    if (
    ...
    // Only if email is valid then check to see if it's akready taken
    if (validator.isEmail(this.data.email)) {
...
module.exports = User;
>>>>>>> d67cf2c35c3a4282664ce4300b6b07a3ddc5b285
